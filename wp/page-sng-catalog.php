  ...
  <section class="">
    <div class="containers flex">
      ...
      <article class="sub-conts article">
        ...
        <div class="wp-slick">
          <div id="wp-slick">
            <figure><img src="<?php echo assets_path() ?>img/common/img-single01.jpg" alt=""></figure>
            <figure><img src="<?php echo assets_path() ?>img/common/img-single01.jpg" alt=""></figure>
            <figure><img src="<?php echo assets_path() ?>img/common/img-single01.jpg" alt=""></figure>
          </div>
        </div>
        
        <h2 class="article__desc">資料説明文が入ります。資料説明文が入ります。資料説明文が入ります。資料説明文が入ります。資料説明文が入ります。資料説明文が入ります。資料説明文が入ります。資料説明文が入ります。資料説明文が入ります。資料説明文が入ります。</h2>
          ...
          <div class="form__table">
            <table>
              ...
              <tbody><tr>
                ...
                <td><input type="text" placeholder="例）○○株式会社"></td>
              </tr>
              <tr>
                <th class="flex aiC">
              ...
              <tr>
                ...
                <td><div class="flex fS aiC"><input type="checkbox">同意する</div><p>弊社Webサイトの<a href="<?php echo esc_url( home_url( '/' ) ); ?>privacy/">プライバシーポリシー</a>をご確認の上、ご同意いただき送信をお願いいたします。</p></td>
              </tr>
            </tbody></table>
            <button type="submit" class="more small"><span>確認画面へ進む</span></button>
          </div>
        </form>
        <!-- カイロスタグ挿入 end -->
