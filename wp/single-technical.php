<?php
global $relation_catalog_arr;
global $relation_technical_arr;
$post_id = get_the_ID();
...
$relation_technical_arr = CFS()->get('relation_technical');
  ...
  <section class="breadcrumb">
    <div class="containers">
      <ul class="flex fS">
        ...
        <li><a href="<?php echo esc_url(home_url('/')); ?>technical/">技術情報</a></li>
  ...
  <section class="">
    <div class="containers flex">
      ...
      <article class="main-conts single">
        ...
        <?php get_template_part('parts/content', 'technical'); ?>
