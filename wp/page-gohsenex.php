...
<main class="gohsenex">
  ...
  <section class="feature bg-LB">
    <div class="containers">
      <h2 class="ttl-secondary">ゴーセネックス™の特徴</h2>
      <div class="lead">追加する変性基により、ゴーセネックスはさまざまな特徴を付与できます。</div>
      <ul class="flex gap30 card">
        <li class="card__box" data-aos="fade-up">
          <h3 class="card__box--ttl"><span>易架橋性のPVOH</span>ゴーセネックス™ Z</h3>
          <div class="card__box--txt">分子内に反応性に優れたアセトアセチル基を有する特殊変性PVOHです。<br>水溶性でありながら、各種架橋剤や熱処理、UV照射などにより容易に架橋し、耐水化できます。</div>
        </li>
        <li class="card__box" data-aos="fade-up" data-aos-delay="100">
          <h3 class="card__box--ttl"><span>柔軟性に優れたPVOH</span>ゴーセネックス™ WO</h3>
          <div class="card__box--txt">親水性のエチレンオキサイド鎖を側鎖に有する特殊変性PVOHです。<br>水溶性に優れるとともに、柔軟性に優れた皮膜を形成します。溶融加工適性も有しています。</div>
        </li>
        <li class="card__box" data-aos="fade-up" data-aos-delay="200">
          <h3 class="card__box--ttl"><span>分散特性に優れる強アニオン性PVOH</span>ゴーセネックス™ L</h3>
          <div class="card__box--txt">分子内に強アニオン性のスルホン酸基を有する特殊変性PVOHです。<br>優れた溶解性を有するとともに、分散剤や保護コロイド剤として優れた特性を発揮します。</div>
        </li>
        <li class="card__box" data-aos="fade-up" data-aos-delay="300">
          <h3 class="card__box--ttl"><span>水溶液タイプの低ケン化度PVOH</span>ゴーセネックス™ LW</h3>
          <div class="card__box--txt">低ケン化度PVOHの疎水性の特徴を有する、水溶液タイプの特殊変性PVOHです。<br>皮膜は粘着性があり、各種基材への接着性に優れています。</div>
        </li>
        <li class="card__box" data-aos="fade-up" data-aos-delay="400">
          <h3 class="card__box--ttl"><span>易溶解性のアニオン性PVOH</span>ゴーセネックス™ T</h3>
          <div class="card__box--txt">分子内にカルボキシル基を有するアニオン性の特殊変性PVOHです。<br>水溶性に優れるとともに、水溶液は低発泡かつ粘度安定性、流動特性に優れています。多価金属イオンとキレートを形成します。</div>
        </li>
        <li class="card__box" data-aos="fade-up" data-aos-delay="500">
          <h3 class="card__box--ttl"><span>カチオン性のPVOH</span>ゴーセネックス™ K</h3>
          <div class="card__box--txt">四級アンモニウム塩基を有するカチオン性の特殊変性PVOHです。<br>負電荷を有する材料に対し、優れた密着性・吸着性を示します。</div>
        </li>
      </ul>
