    ...
    <div class="containers">
      ...
      <summary class="card" data-aos="fade-up">
        ...
        <ul class="flex jcC gap30 card__btn">
          <li><a href="#" class="more-data">ゴーセノール™の特性</a></li>
          <li><a href="#" class="more-data">ゴーセノール™の使用法</a></li>
          <li><a href="#" class="more-data">カテゴリ名</a></li>
        </ul>
        <div class="taC"><a href="#" class="txt-link"><span>ゴーセノール™の技術情報一覧を見る</span><img src="<?php echo assets_path() ?>img/common/bg-more.svg" alt="ゴーセノール™の技術情報一覧を見る"></a></div>
      </summary>
      <summary class="card" data-aos="fade-up" data-aos-delay="200">
        <h3 class="card__ttl v2">ゴーセネックス™の技術情報</h3>
        <ul class="flex jcC gap30 card__btn">
          <li><a href="#" class="more-data">ゴーセネックス™の特性</a></li>
          <li><a href="#" class="more-data">ゴーセネックス™の使用法</a></li>
          <li><a href="#" class="more-data">カテゴリ名</a></li>
        </ul>
        <div class="taC"><a href="#" class="txt-link"><span>ゴーセネックス™の技術情報一覧を見る</span><img src="<?php echo assets_path() ?>img/common/bg-more.svg" alt="ゴーセネックス™の技術情報一覧を見る"></a></div>
      </summary>
      <summary class="card" data-aos="fade-up" data-aos-delay="300">
        <h3 class="card__ttl v3">ニチゴーGポリマー™の技術情報</h3>
        <ul class="flex jcC gap30 card__btn">
          <li><a href="#" class="more-data">ニチゴーGポリマー™の特性</a></li>
          <li><a href="#" class="more-data">ニチゴーGポリマー™の使用法</a></li>
          <li><a href="#" class="more-data">カテゴリ名</a></li>
        </ul>
        <div class="taC"><a href="#" class="txt-link"><span>ニチゴーGポリマー™の技術情報一覧を見る</span><img src="<?php echo assets_path() ?>img/common/bg-more.svg" alt="ニチゴーGポリマー™の技術情報一覧を見る"></a></div>
      </summary>
    </div>
