          ...
          <div class="nav-wrap">
            ...
            <nav class="nav-list pc-only">
              <ul class="flex jcE gap50 nav-list-box">
                        ...
                        <ul class="mega__child--list">
                          <li class="flex aifS nav-link">
                            ...
                            <ul class="flex child-link">
                              ...
                              <li><a href="<?php echo esc_url(home_url('/')); ?>gohsenol/#anchor02">使用用途</a></li>
                          ...
                          <li class="flex aifS nav-link">
                            ...
                            <ul class="flex child-link">
                              ...
                              <li><a href="<?php echo esc_url(home_url('/')); ?>gohsenex/#anchor02">使用用途</a></li>
                          ...
                          <li class="flex aifS nav-link">
                            ...
                            <ul class="flex child-link">
                              ...
                              <li><a href="<?php echo esc_url(home_url('/')); ?>g-polymer/#anchor02">使用用途</a></li>
                ...
                <li class="parent">
                  <a href="<?php echo esc_url(home_url('/')); ?>usage/" class="arrow">使用用途</a>
                  <div class="mega flex pull">
                    <div class="mega__menu">
                      <div class="mega__menu--ttl"><a href="<?php echo esc_url(home_url('/')); ?>usage/">使用用途</a></div>
                      <div class="mega__child">
                        <ul class="mega__child--list">
                          <li class="flex aifS nav-link">
                            <a href="#" class="ttl-link disabled">ゴーセノール™</a>
                          ...
                          <li class="flex aifS nav-link">
                            ...
                            <ul class="flex aifS child-link">
                              ...
                              ?>
                                ...
                                ?>
                                  <li><a href="<?php the_permalink(); ?>" class="inline"><?php the_title(); ?></a></li>
                                <?php endwhile; ?>
                              <?php endif; ?>
                      ...
                      <div class="mega__child">
                        <ul class="mega__child--list">
                          <li class="flex aifS nav-link">
                            ...
                            <ul class="flex aifS child-link">
                              <li><a href="<?php echo esc_url(home_url('/')); ?>technical/category/gohsenol/">ゴーセノール™</a></li>
                              <li><a href="<?php echo esc_url(home_url('/')); ?>technical/category/g-polymer/">ニチゴーG-ポリマー™</a></li>
                              <!-- <li><a href="<?php echo esc_url(home_url('/')); ?>technical/gohsenex/">ゴーセネックス™</a></li> -->
                            </ul>
                          </li>
                          <li class="flex aifS nav-link">
                            <a href="<?php echo esc_url(home_url('/')); ?>knowledge/" class="ttl-link">お役立ち情報</a>
                            <ul class="flex aifS child-link">
                ...
                <li><a href="https://www.m-chemical.co.jp/company/profile/index.html" class="link" target="_blank">企業情報</a></li>
                <li><a href="<?php echo esc_url(home_url('/')); ?>sales_office/" class="link">販売拠点</a></li>
              </ul>
            </nav>
          </div>
