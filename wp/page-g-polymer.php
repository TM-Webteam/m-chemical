  ...
  <section id="anchor01" class="sec01">
    <div class="containers">
      ...
      <div class="flex aiC sp-reverse">
        <dl class="sec01__box">
          <dt><h3>革新的新素材！！<br>ブテンジオールビニルアルコールポリマー（BVOH）</h3></dt>
  ...
  <section class="feature bg-LB">
    <div class="containers">
      ...
      <div class="feature__btn taC">
        ...
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>technical/g-polymer/" class="txt-link"><span>技術情報を見る</span><img src="<?php echo assets_path() ?>img/common/bg-more.svg" alt="技術情報を見る"></a>
      </div>
    </div>
  </section>
